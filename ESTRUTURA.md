...
> **@Gcazi — Guilherme Casanova**

Este arquivo documenta a organização, os recursos visuais e o funcionamento do README do perfil do GitHub `@Gcazi`. Sempre que o `README.md` for alterado, esta documentação deve ser atualizada para continuar refletindo o estado real do repositório.
...
| 3 | Sobre mim (info pessoal) | Dados pessoais em destaque | Tabela (Nome, Usuário, Local, Curso, Período, Objetivo), gif, contadores | `killua.gif` | Komarev, Shields.io |
...
| 10 | Arte & Ilustração | Divulgação do trabalho artístico | Texto + logo + link para Instagram | `logo-instagram.svg`, `name_instagram.svg` | Instagram (@kallereall) |
...
| Instagram (@kallereall) | Conta de arte/ilustração |
...
| Canal | Link |
|-------|------|
| GitHub | https://github.com/Gcazi |
| Behance | https://www.behance.net/Gcazi |
| E-mail | guilhermeecasanova@gmail.com |
| LinkedIn | https://www.linkedin.com/in/gcaziv |
| Instagram (arte) | https://www.instagram.com/kallereall |
...
| Cor | Hex | Uso |
|-----|-----|-----|
| Azul principal | `#53A8F5` | Typing SVG, badges de nível, ícones do "Sobre mim", contador de visitantes, badge de seguidores, streak stats (borda/ring/label), gráfico de atividade (cor/borda) |
| Verde streak/gráfico | `#39D353` | Streak stats (fire), gráfico de atividade (linha) |
| Verde de área | `#006622` | Preenchimento de área do gráfico de atividade |
...
| Branco | `#FFFFFF` | Ponto de destaque no gráfico de atividade |

---

## 9. GitHub Stats e atividade

- **Streak:** gerado por `streak-stats.demolab.com`, usando `theme=merko` com `border`, `ring`, `currStreakLabel` e `sideLabels` em `#53A8F5`, `fire` em `#39D353`, datas em `#C9D1D9` e fundo `#0D1117`. Exibe a sequência atual de contribuições.
- **Gráfico de atividade:** gerado por `github-readme-activity-graph.vercel.app`, com `bg_color=0d1117`, `color=53A8F5`, `line=39d353`, `point=ffffff`, `area=true`, `area_color=006622` e `border_color=53A8F5`. Exibe visualmente as contribuições ao longo do tempo.
...
- Wordmark `name_instagram.svg`, linkado para a conta `@kallereall` no Instagram (https://www.instagram.com/kallereall).

---

## 11. Footer

- **Nome:** Guilherme Casanova
- **Usuário GitHub:** @Gcazi (link para https://github.com/Gcazi)
...
- [ ] `killua.gif` está presente e carregando corretamente
...
- [ ] Link do Instagram de arte (@kallereall) está correto
...
<div align="center">
  <sub>Documentação para <strong>@Gcazi — Guilherme Casanova</strong></sub>
</div>
